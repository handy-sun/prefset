...
case $IP_INDEX in
1)
    echo "该网段网络号为: ${AVAILABLE_MIN_IP}.0.0.0"
    echo "最小可用地址为: ${AVAILABLE_MIN_IP}.0.0.1"
    echo "最大可用地址为: ${AVAILABLE_MAX_IP}.255.255.254"
    echo "网段广播地址为: ${AVAILABLE_MAX_IP}.255.255.255"
    ;;
2)
    echo "该网段网络号为: ${IP_SUB1}.${AVAILABLE_MIN_IP}.0.0"
    echo "最小可用地址为: ${IP_SUB1}.${AVAILABLE_MIN_IP}.0.1"
    echo "最大可用地址为: ${IP_SUB1}.${AVAILABLE_MAX_IP}.255.254"
    echo "网段广播地址为: ${IP_SUB1}.${AVAILABLE_MAX_IP}.255.255"
    ;;
3)
    echo "该网段网络号为: ${IP_SUB1}.${IP_SUB2}.${AVAILABLE_MIN_IP}.0"
    echo "最小可用地址为: ${IP_SUB1}.${IP_SUB2}.${AVAILABLE_MIN_IP}.1"
    echo "最大可用地址为: ${IP_SUB1}.${IP_SUB2}.${AVAILABLE_MAX_IP}.254"
    echo "网段广播地址为: ${IP_SUB1}.${IP_SUB2}.${AVAILABLE_MAX_IP}.255"
    ;;
4)
    echo "该网段网络号为: ${IP_SUB1}.${IP_SUB2}.${IP_SUB3}.${AVAILABLE_MIN_IP}"
    echo "最小可用地址为: ${IP_SUB1}.${IP_SUB2}.${IP_SUB3}.$[${AVAILABLE_MIN_IP}+1]"
    echo "最大可用地址为: ${IP_SUB1}.${IP_SUB2}.${IP_SUB3}.$[${AVAILABLE_MAX_IP}-1]"
    echo "网段广播地址为: ${IP_SUB1}.${IP_SUB2}.${IP_SUB3}.${AVAILABLE_MAX_IP}"
    ;;
*)
